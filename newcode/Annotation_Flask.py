...
Details:
	...
	res=annotations.AddSequenceAnnotations(g.con,g.cur,sequences,primer,expid,annotationtype,annotationlist,method,description,agenttype,private,userid,commit=True)
	if res>0:
		debug(2,'added sequece annotations')
		return("wokrd ok")
	debug(6,"error encountered")
	return ("error enountered",400)
